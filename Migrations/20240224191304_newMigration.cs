        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AppuserStockOverview_AspNetUsers_AppusersId",
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    StockOverviewId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    OpenValue = table.Column<decimal>(type: "decimal(18,2)", nullable: true),
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { "66c08a32-6287-47ae-910a-bc814773fc68", null, "Admin", "ADMIN" });

            migrationBuilder.InsertData(
                table: "AspNetRoles",
                columns: new[] { "Id", "ConcurrencyStamp", "Name", "NormalizedName" },
                values: new object[] { "aa6100e3-a5f2-4d8b-bbf0-eca645699702", null, "User", "USER" });
